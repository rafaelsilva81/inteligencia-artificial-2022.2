...
public class BuscaAEstrela {
    ...
    public BuscaAEstrela(Graph graph, Node start, Node goal) {
        this.graph = graph;
        this.start = start;
        this.goal = goal;
    ...
    public void search() {
        ...
        // nesse algoritmo, a comparação é feita pela soma do custo acumulado e o dado heuristico
        Comparator<? super Node> comparator = new Comparator<Node>() {
            @Override
            public int compare(Node o1, Node o2) {
                return (o1.getCost() + dados_heuristicos.get(o1)) - (o2.getCost() + dados_heuristicos.get(o2));
            }
        };
